...
class ClientHelloParser:
    ...
    def parse(self, data: bytes) -> ClientHelloInfo:
        ...
        try:
            ...
            return ClientHelloInfo(
                record_len=0, hs_len=0, record_version="unknown",
                client_version="unknown", sni=None, sni_offset=None,
                extensions=[], ja3="", error=str(e)
            )
    ...
    def _parse_impl(self, data: bytes) -> ClientHelloInfo:
        ...
        return ClientHelloInfo(
            record_len=record_len, hs_len=hs_len,
            record_version=record_version, client_version=client_version,
            sni=sni, sni_offset=sni_offset, extensions=extensions,
            ja3=ja3, cipher_suites=cipher_suites,
            supported_groups=supported_groups, ec_point_formats=ec_point_formats
        )
    ...
    def calculate_ja3(
        self, version: str, cipher_suites: List[int],
        extensions: List[int], groups: List[int], formats: List[int]
    ) -> str:
        """
