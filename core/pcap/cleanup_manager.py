...
class PCAPCleanupManager:
    ...
    def __init__(self, temp_dir: Optional[str] = None, 
        ...
        self.logger.info(f"Cleanup manager initialized: dir={self.temp_dir}, "
    ...
    def run_cleanup(self) -> dict:
        ...
        try:
            ...
            for file_path in pcap_files:
                try:
                    ...
                    if should_delete:
                        ...
                        self.logger.debug(f"Cleaned up {file_path.name} ({file_size} bytes, {reason})")
            ...
            if files_cleaned > 0:
                self.logger.info(f"🗑️ Cleanup completed: {files_cleaned} files, "
    ...
    def emergency_cleanup(self) -> dict:
        ...
        try:
            ...
            self.logger.warning(f"🚨 Emergency cleanup completed: {files_cleaned} files, "
