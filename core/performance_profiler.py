...
class PerformanceProfiler:
    ...
    def profile_operation(self, operation_name: str):
        ...
        """
        metrics = PerformanceMetrics(operation_name=operation_name, execution_time=0.0)
    ...
    def generate_report(
        self, component: str, include_recommendations: bool = True
    ) -> ProfileReport:
        """
        ...
        if self.metrics:
            ...
            report.summary = {
                ...
                "slowest_operation": max(
                    self.metrics, key=lambda m: m.execution_time
                ).operation_name,
            }
    ...
    def _generate_recommendations(self, report: ProfileReport) -> List[str]:
        ...
        for metric in report.metrics:
            operation_counts[metric.operation_name] = (
                operation_counts.get(metric.operation_name, 0) + 1
            )
