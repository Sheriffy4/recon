...
class StrategySelector:
    ...
    def __init__(self, 
        ...
        self.logger.info(f"StrategySelector initialized with {len(self.domain_rules)} domain rules, "
    ...
    def _log_rule_summary(self) -> None:
        ...
        self.logger.debug(f"Rule summary: {exact_rules} exact, {wildcard_rules} wildcard, "
    ...
    def select_strategy(self, sni: Optional[str], dst_ip: str) -> StrategyResult:
        ...
        if sni:
            ...
            if result:
                ...
                self.logger.info(f"Wildcard strategy for SNI={sni} (pattern={result.domain_matched}): {result.strategy}")
                return result
    ...
    def __str__(self) -> str:
        ...
        return (f"StrategySelector(domain_rules={len(self.domain_rules)}, "
