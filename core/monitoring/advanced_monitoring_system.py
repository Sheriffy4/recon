...
class MetricCollector:
    ...
    def get_metric_stats(self, name: str, time_window_minutes: Optional[int] = None) -> Dict[str, float]:
...
class AlertManager:
    ...
    def _log_alert_handler(self, alert: Alert) -> None:
        ...
        self.logger.log(level, f"ALERT: {alert.message} (Value: {alert.value}, Threshold: {alert.threshold})")
...
class AdvancedMonitoringSystem:
    ...
    def _collect_performance_metrics(self, timestamp: datetime) -> None:
        ...
        if recent_results:
            ...
            errors = sum(1 for r in recent_results if r.status in [AttackStatus.ERROR, AttackStatus.FAILED])
    ...
    def get_monitoring_dashboard(self) -> Dict[str, Any]:
        ...
        # Add recent metrics
        for metric_name in ['success_rate', 'average_latency', 'error_rate', 'system_health_score']:
