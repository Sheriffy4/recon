...
class PerformanceMonitor:
    ...
    def __init__(self,
        ...
        # Metrics storage
        self.system_metrics_history = deque(maxlen=int(3600 * history_retention_hours / collection_interval))
    ...
    def _check_operation_alerts(self, op_metrics: OperationMetrics):
        ...
        # Duration alert
        if (op_metrics.duration_ms and 
            op_metrics.duration_ms > self.alert_thresholds["operation_duration_ms"]):
    ...
    def get_performance_summary(self) -> Dict[str, Any]:
        ...
        with self._lock:
            ...
            total_ops = self.stats["total_operations"]
            error_rate = (
                (self.stats["failed_operations"] / total_ops * 100) 
    ...
    def get_bottleneck_analysis(self) -> Dict[str, Any]:
        ...
        with self._lock:
            ...
            slow_operations = [
                ...
                if op.duration_ms and op.duration_ms > self.alert_thresholds["operation_duration_ms"]
            ]
...
def initialize_performance_monitoring(collection_interval: float = 1.0,
                                    enable_alerts: bool = True) -> PerformanceMonitor:
