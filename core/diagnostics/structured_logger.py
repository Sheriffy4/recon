...
class StructuredLogger:
    ...
    def _write_log_entry(self, entry: Dict[str, Any]):
        ...
        with self._lock:
            try:
                ...
                if (
                    self.enable_console
                    and self.console_handler
                    and entry.get("level") in ["error", "critical", "warning"]
                ):
    ...
    def log_system_event(self, event_name: str, data: Dict[str, Any]):
        ...
        self.log_structured(
            LogLevel.INFO, LogCategory.SYSTEM, f"System event: {event_name}", data=data
        )

    def log_strategy_test_start(
        self, strategy_name: str, domain: str, parameters: Dict[str, Any]
    ) -> str:
    ...
    def log_validation_result(
        self, validation_type: str, target: str, success: bool, details: Dict[str, Any]
    ):
    ...
    def log_dpi_analysis(
        self, domain: str, analysis_type: str, results: Dict[str, Any], confidence: float
    ):
    ...
    def log_network_event(self, event_type: str, domain: str, details: Dict[str, Any]):
        ...
        self.log_structured(
            ...
            data={"event_type": event_type, "domain": domain, "details": details},
        )
    ...
    def get_performance_summary(self) -> Dict[str, Any]:
        ...
        with self._lock:
            ...
            return {
                ...
                "success_rate": (
                    len(successful_ops) / len(self._performance_history)
...
def initialize_structured_logging(
    ...
    _structured_logger = StructuredLogger(
        log_file=log_file, enable_console=enable_console, log_level=log_level
    )
