...
from .dpi_behavior_monitor import (
    DPIBehaviorMonitor, MonitoringConfig, MonitoringAlert, AlertSeverity
)
...
class DPIMonitoringDemo:
    ...
    def setup_components(self):
        ...
        self.fingerprinter = AdvancedFingerprinter(
            ...
            cache_file="demo_fingerprint_cache.pkl"
        )
    ...
    async def demo_force_checks(self):
        ...
        for domain, port in test_targets:
            ...
            try:
                ...
                if target_status:
                    logger.info(f"  Target status: {target_status['behavior_changes']} changes, "
    ...
    async def demo_performance_monitoring(self):
        ...
        adaptive_interval = perf_monitor.get_adaptive_interval(
            base_interval, min_interval, max_interval,
