...
class EnhancedDPIAnalyzer(BaseDPIAnalyzer):
    ...
    def _run_quick_tests(self) -> Dict[str, Any]:
        ...
        features = {"test_mode": "quick", "timestamp": datetime.now().isoformat()}
    ...
    def _quick_sni_test(self) -> Dict[str, Any]:
        ...
        try:
            ...
            sni_filtering = correct_result.get("blocked", False) != wrong_result.get(
                "blocked", False
            )
            ...
            return {"sni_filtering_detected": False, "error": str(e), "confidence": 0.0}
    ...
    def _test_fragmentation_support(self) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"supports_fragmentation": None, "error": str(e), "confidence": 0.0}

    def _test_tls_versions(self) -> Dict[str, Any]:
        """Тестирование различных версий TLS"""
        print("  🔍 Тест версий TLS...")

        versions = {"TLS 1.0": 0x0301, "TLS 1.1": 0x0302, "TLS 1.2": 0x0303, "TLS 1.3": 0x0304}
    ...
    def _test_statefulness(self) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"dpi_type": "unknown", "error": str(e), "confidence": 0.0}
    ...
    def _update_fingerprint_from_tests(self, fingerprint: DPIFingerprint, features: Dict[str, Any]):
        ...
        elif features.get("tcp_connection", {}).get("success") and not features.get(
            "tls_handshake", {}
        ).get("success"):
    ...
    def _send_tls_hello(self, hello_packet: bytes) -> Dict[str, Any]:
        ...
        try:
            ...
            try:
                ...
                return {"blocked": True, "response_time_ms": 5000, "timeout": True}
            finally:
                sock.close()
    ...
    def _send_fragmented_packets(self, fragments: List[bytes]) -> Dict[str, Any]:
        ...
        return {"blocked": True, "reassembled": False, "timeout_ms": 1000}
