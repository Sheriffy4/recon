...
class TestAdvancedFingerprintingConfig(unittest.TestCase):
    ...
    def test_validate_invalid_network_config(self):
        ...
        self.assertTrue(any("concurrent limit must be positive" in error for error in errors))
    ...
    def test_validate_invalid_ml_config(self):
        ...
        self.assertGreater(len(errors), 0)
        self.assertTrue(any("confidence threshold must be between 0 and 1" in error for error in errors))
        self.assertTrue(any("retrain threshold must be between 0 and 1" in error for error in errors))
    ...
    def test_validate_invalid_analyzer_config(self):
        ...
        self.assertGreater(len(errors), 0)
        self.assertTrue(any("tcp timeout must be positive" in error for error in errors))
        self.assertTrue(any("http max samples must be positive" in error for error in errors))
        self.assertTrue(any("dns confidence weight cannot be negative" in error for error in errors))
