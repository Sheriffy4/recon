...
class TestMetricsCollector(unittest.TestCase):
    ...
    def test_validate_comprehensive_metrics_invalid(self):
        ...
        metrics.protocols['http'] = ProtocolMetrics(protocol='http', success_rate=1.5)  # Invalid success rate
    ...
    def test_aggregate_metrics_multiple_items(self):
        ...
        self.assertEqual(result.protocols['http'].success_rate, 0.7)  # Average of 0.8 and 0.6
