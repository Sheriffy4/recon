...
class MLClassifier:
        ...
        try:
            ...
            for example in training_data:
                if 'metrics' not in example or 'dpi_type' not in example:
                    LOG.warning("Skipping invalid training example: missing 'metrics' or 'dpi_type'")
                    continue
    ...
    def get_prediction_with_alternatives(self, metrics: Dict[str, Any]) -> Tuple[str, float, List[Tuple[str, float]]]:
        """
