...
class BlockedDomainDetector:
    ...
    BLOCKED_IP_INDICATORS = {
        ...
        '172.16.0.1', '203.0.113.0'  # RFC 5737 test addresses
    }
    ...
    async def _detect_block_type(self, domain: str, system_ips: Set[str], 
                                doh_ips: Set[str]) -> Tuple[bool, str]:
    ...
    async def check_domain(self, domain: str, force_refresh: bool = False) -> DomainStatus:
        ...
        LOG.info(f"Домен {domain}: заблокирован={is_blocked}, тип={block_type}, "
    ...
    def get_blocked_domains(self) -> List[str]:
        ...
        return [
            domain for domain, status in self.domain_cache.items()
