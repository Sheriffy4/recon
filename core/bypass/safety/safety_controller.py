...
from ..attacks.attack_definition import AttackDefinition
...
from .exceptions import (
    ...
    SandboxViolationError, EmergencyStopError, AttackValidationError
)
...
class ExecutionRecord:
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "validation": {
                "pre_validation_score": self.pre_validation.safety_score if self.pre_validation else None,
                "post_validation_score": self.post_validation.safety_score if self.post_validation else None
            },
            "result": {
...
class SafetyController:
    ...
    @contextmanager
    def execute_attack_sync(self, attack: BaseAttack, context: AttackContext, 
        ...
        try:
            ...
            try:
                ...
                if resource_monitor:
                    ...
                    if usage_summary:
                        record.resource_violations = 0  # Would be set by monitor if violations occurred
    ...
    @asynccontextmanager
    async def execute_attack_async(self, attack: BaseAttack, context: AttackContext, 
                                  timeout: Optional[float] = None):
        """
