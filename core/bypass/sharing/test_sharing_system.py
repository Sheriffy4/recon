...
class TestSharingModels:
    ...
    def test_strategy_signature(self):
        ...
        strategy = SharedStrategy(
            ...
            name="Test Strategy",
            description="A test strategy",
            strategy_data={"attacks": ["tcp_fragment"]},
            author="test_user",
            version="1.0.0",
            share_level=ShareLevel.COMMUNITY,
...
class TestStrategyValidator:
    ...
    async def test_suspicious_strategy_validation(self, validator):
        ...
        strategy = SharedStrategy(
            id="suspicious_strategy",
            name="Suspicious Strategy",
            description="A suspicious test strategy",
            strategy_data={
                "attacks": ["tcp_fragment"],
                "parameters": {"command": "exec('malicious_code')", "mss": 1200},
            },
            author="test_user",
            version="1.0.0",
            share_level=ShareLevel.COMMUNITY,
...
class TestCommunityDatabase:
    ...
    async def test_feedback_system(self, temp_db):
        ...
        strategy = SharedStrategy(
            ...
            description="A strategy for testing feedback",
            strategy_data={"attacks": ["tcp_fragment"], "parameters": {"mss": 1200}},
            author="test_user",
            version="1.0.0",
            share_level=ShareLevel.COMMUNITY,
...
class TestSharingManager:
    ...
    async def test_download_strategy(self, temp_manager):
        ...
        strategy = SharedStrategy(
            id="download_test",
            name="Download Test Strategy",
            description="A strategy for download testing",
            strategy_data={"attacks": ["tcp_fragment"], "parameters": {"mss": 1200}},
            author="test_user",
            version="1.0.0",
            share_level=ShareLevel.COMMUNITY,
    ...
    async def test_search_strategies(self, temp_manager):
        ...
        mock_strategies = [
            SharedStrategy(
                id="search_test_1",
                name="Search Test 1",
                description="First search test strategy",
                strategy_data={"attacks": ["tcp_fragment"]},
                author="test_user",
                version="1.0.0",
                share_level=ShareLevel.COMMUNITY,
    ...
    async def test_export_import_strategies(self, temp_manager):
        ...
        strategy = SharedStrategy(
            ...
            description="A strategy for export testing",
            strategy_data={"attacks": ["tcp_fragment"], "parameters": {"mss": 1200}},
            author="test_user",
            version="1.0.0",
            share_level=ShareLevel.COMMUNITY,
