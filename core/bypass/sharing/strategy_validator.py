...
from .sharing_models import (
    SharedStrategy, ValidationResult, ValidationStatus, 
    TrustLevel, StrategyFeedback
)
...
class StrategyValidator:
    ...
    def _has_suspicious_parameters(self, strategy_data: Dict[str, Any]) -> bool:
        ...
        suspicious_keys = [
            'system_command', 'shell_exec', 'file_write', 
            'network_raw', 'admin_required'
        ]
    ...
    def _validate_attack_ids(self, attack_ids: List[str]) -> bool:
        ...
        valid_prefixes = [
            'tcp_', 'http_', 'tls_', 'dns_', 
            'timing_', 'obfuscation_', 'header_'
        ]
