...
async def test_strategy_effectiveness_phase():
    ...
    try:
        ...
        legacy_result = await validator._simulate_legacy_strategy_effectiveness(test_domain)
...
async def test_report_generation():
    ...
    from recon.core.bypass.testing.comprehensive_system_test import (
        AttackValidationResult, StrategyEffectivenessResult, StabilityTestResult
    )
    ...
    assert "COMPREHENSIVE SYSTEM VALIDATION REPORT" in text_report, "Missing report header"
...
async def run_quick_comprehensive_test():
    ...
    try:
        ...
        print(f"  System metrics: {len(validator.metrics_collector.metrics)} data points collected")
