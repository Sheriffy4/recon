...
class TestCase:
    ...
    def from_dict(cls, data: Dict[str, Any]) -> 'TestCase':
        ...
        return cls(
            ...
            validation_methods=[ValidationMethod(vm) for vm in data.get('validation_methods', [])],
...
class TestResult:
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'validation_results': {vm.value: result for vm, result in self.validation_results.items()},
