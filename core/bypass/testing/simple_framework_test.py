...
from recon.core.bypass.testing.test_models import TestCase, TestStatus, ValidationMethod
...
async def test_framework_basic_functionality():
    ...
    try:
        ...
        LOG.info(f"✓ Quick test suite completed: {report.passed_tests}/{report.total_tests}")
...
async def test_configuration():
    ...
    try:
        ...
        if max_parallel:
            LOG.info(f"✓ Configuration access works: max_parallel_tests = {max_parallel}")
