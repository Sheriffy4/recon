...
from .attack_test_suite import ComprehensiveTestSuite, run_quick_test_suite
from .integration_tests import run_integration_tests, run_full_integration_suite
...
class TestRunner:
    ...
    async def _run_comprehensive_tests(self, attack_ids: Optional[List[str]] = None) -> TestReport:
        ...
        return await suite.run_comprehensive_tests(
            ...
            stability_duration_minutes=self.config.get('stability_settings.duration_minutes'),
...
async def main():
    ...
    parser.add_argument('test_type', choices=[
        'quick', 'comprehensive', 'stability', 'benchmark', 
        'integration', 'regression', 'category', 'complexity'
    ...
    try:
        ...
        # Print summary
        print(f"\nTest Summary:")
        print(f"Total: {report.total_tests}, Passed: {report.passed_tests}, "
