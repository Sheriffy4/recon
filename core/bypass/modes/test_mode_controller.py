...
from .mode_controller import ModeController, OperationMode, ModeInfo
...
from .exceptions import ModeError, ModeTransitionError, UnsupportedModeError
...
class TestCapabilityDetector:
    ...
    def test_native_mode_availability_windows(self, mock_system):
        ...
        detector._capabilities_cache = {
            'pydivert': CapabilityInfo(CapabilityLevel.FULL, "Available", {}, True, True),
            'admin_privileges': CapabilityInfo(CapabilityLevel.FULL, "Available", {}, True, False),
            'windivert_driver': CapabilityInfo(CapabilityLevel.FULL, "Available", {}, True, True)
        }
    ...
    def test_native_mode_unavailable_no_admin(self, mock_system):
        ...
        detector._capabilities_cache = {
            'pydivert': CapabilityInfo(CapabilityLevel.FULL, "Available", {}, True, True),
            'admin_privileges': CapabilityInfo(CapabilityLevel.UNAVAILABLE, "No admin", {}, False, False),
            'windivert_driver': CapabilityInfo(CapabilityLevel.FULL, "Available", {}, True, True)
        }
...
class TestModeControllerIntegration:
    ...
    def test_transition_history_integration(self):
        ...
        found_transition = any(
            h['reason'] == "test 1" for h in history
        )
