...
class AnalyticsEngine:
    ...
    def _schedule_periodic_tasks(self):
        ...
        self._tasks.append(
            asyncio.create_task(self._periodic_ml_training())
        )
        ...
        while self._running:
            try:
                ...
                if self._running:
                    ...
                    await self.reporting_dashboard.generate_comprehensive_report(1)  # Last hour
    ...
    async def get_strategy_analytics(self, strategy_id: str) -> Optional[Dict[str, Any]]:
        ...
        return {
            ...
            'prediction': {
                'effectiveness': {
                    'value': effectiveness_prediction.predicted_value if effectiveness_prediction else None,
                    'confidence': effectiveness_prediction.confidence if effectiveness_prediction else None
                }
            }
        }
    ...
    async def get_trend_analysis(self, entity_id: str, metric_type: MetricType, 
    ...
    async def get_prediction(self, entity_id: str, metric_type: MetricType, 
                           hours_ahead: int = 1) -> Optional[Dict[str, Any]]:
    ...
    async def get_historical_data(self, entity_id: str, metric_type: MetricType, 
