...
from .factory import create_engine as _original_create_engine, detect_best_engine
from .engine_type_detector import EngineTypeDetector, get_engine_type_detector
from .engine_validator import EngineValidator, get_engine_validator
from .engine_config_manager import EngineConfigManager, get_engine_config_manager
from .error_handling import (
    ErrorHandler, get_error_handler, ErrorContext, BaseEngineError,
    EngineCreationError as StructuredEngineCreationError, EngineDependencyError, EnginePermissionError,
...
from .config_models import (
    EngineCreationRequest, EngineCreationResult, EnhancedEngineConfig,
    ValidationResult, SerializationFormat
)
...
class EnhancedEngineFactory:
    ...
    def validate_engine_configuration(self, engine_type: EngineType, 
                                    config: Optional[EngineConfig] = None,
    ...
    def validate_engine_dependencies(self, engine_type: EngineType) -> Dict[str, Any]:
        ...
        return {
            ...
            "missing_dependencies": [
                issue.message for issue in dependency_result.issues 
                if issue.severity.value in ["error", "critical"] and "dependency" in issue.message.lower()
            ]
        }
    ...
    def create_error_context(self, engine_type: Optional[EngineType] = None,
