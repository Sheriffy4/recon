# recon/core/bypass/engines/config_models.py
"""
...
from .base import EngineType, EngineConfig, BaseBypassEngine
...
class EngineCreationResult(SerializableModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        data = super().to_dict()
        # Don't serialize the actual engine object
...
class EngineConfigProfile(SerializableModel):
    ...
    def from_dict(cls, data: Dict[str, Any]) -> 'EngineConfigProfile':
        ...
        # Handle fallback_engines conversion
        ...
        # Handle default_config conversion
...
class ConfigurationManager:
    ...
    def serialize_profiles(self, profiles: Dict[EngineType, EngineConfigProfile], 
                          format: SerializationFormat = SerializationFormat.JSON) -> str:
        """Serialize engine profiles to string."""
        profiles_dict = {
            et.value: profile.to_dict() 
            for et, profile in profiles.items()
        }
    ...
    def deserialize_profiles(self, data: str, 
                           format: SerializationFormat = SerializationFormat.JSON) -> Dict[EngineType, EngineConfigProfile]:
    ...
    def convert_format(self, input_file: Union[str, Path], output_file: Union[str, Path],
        ...
        # Simply copy the file for JSON to JSON conversion
        import shutil
...
def create_engine_request(engine_type: Optional[Union[str, EngineType]] = None,
                         **kwargs) -> EngineCreationRequest:
