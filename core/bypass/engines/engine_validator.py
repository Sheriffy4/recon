...
class EngineValidator:
    ...
    def validate_engine_type(
        ...
        if not detection_result.available:
            ...
            for hint in detection_result.installation_hints:
                result.add_issue(
                    ValidationSeverity.INFO, f"Installation hint: {hint}", "engine_type"
                )
    ...
    def validate_parameters(
        self, engine_type: Union[str, EngineType], params: Dict[str, Any]
    ) -> ValidationResult:
        """
    ...
    def validate_config(
        self, config: EngineConfig, engine_type: Optional[EngineType] = None
    ) -> ValidationResult:
        """
    ...
    def _validate_parameter_values(
        self, engine_type: EngineType, params: Dict[str, Any], result: ValidationResult
    ):
...
def validate_parameters(
    engine_type: Union[str, EngineType], params: Dict[str, Any]
) -> ValidationResult:
