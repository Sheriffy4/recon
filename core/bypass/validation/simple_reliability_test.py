...
def test_basic_functionality():
    ...
    effectiveness = validator._calculate_effectiveness_score(
        mock_accessibility_results, baseline_result
    )
...
async def test_mocked_network_operations():
    ...
    with patch.object(validator, "_run_validation_method") as mock_run:
        mock_results = [
            ...
            ValidationResult(
                method=ValidationMethod.DNS_RESOLUTION, success=True, response_time=0.2
            ),
        ]
