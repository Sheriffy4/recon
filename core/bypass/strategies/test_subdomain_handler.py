...
try:
    from .subdomain_handler import (
        SubdomainStrategyHandler, EnhancedPoolManager, SubdomainType, PlatformType,
        SubdomainPattern, SubdomainStrategy, PlatformConfiguration,
        analyze_subdomain_structure, suggest_subdomain_tests
    )
...
class TestSubdomainStrategyHandler(unittest.TestCase):
    ...
    def test_subdomain_type_detection(self):
        ...
        test_cases = [
            ...
            ("r1---sn-4g5e6nls.googlevideo.com", PlatformType.YOUTUBE, SubdomainType.MEDIA_CONTENT),
