...
import os
try:
    from recon.core.bypass.strategies.subdomain_handler import SubdomainStrategyHandler, EnhancedPoolManager, SubdomainType, PlatformType, SubdomainPattern, SubdomainStrategy, PlatformConfiguration, analyze_subdomain_structure, suggest_subdomain_tests
