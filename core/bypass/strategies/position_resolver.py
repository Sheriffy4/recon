...
from .exceptions import PacketTooSmallError
...
class PositionResolver:
    ...
    def resolve_numeric_positions(self, packet: bytes, positions: List[int]) -> List[int]:
        ...
        """
        if not packet:
            raise PacketTooSmallError(0, 1, "position resolution")
    ...
    def _is_client_hello(self, packet: bytes) -> bool:
        ...
        try:
            ...
            return record_type == 0x16 and version >= 0x0301 and handshake_type == 0x01
