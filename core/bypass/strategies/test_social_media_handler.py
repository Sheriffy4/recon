...
try:
    from recon.core.bypass.strategies.social_media_handler import SocialMediaBypassHandler, MediaType, BlockingPattern, PlatformType, YouTubeSpecificConfig, TwitterSpecificConfig, InstagramSpecificConfig, TikTokSpecificConfig, PlatformSpecificStrategy
    from recon.core.bypass.strategies.subdomain_handler import SubdomainStrategyHandler, SubdomainType
    from recon.core.bypass.strategies.pool_management import BypassStrategy, StrategyPoolManager
except ImportError:
    import sys
    import os
    sys.path.append(os.path.dirname(__file__))
    from social_media_handler import SocialMediaBypassHandler, MediaType, BlockingPattern, PlatformType, PlatformSpecificStrategy
