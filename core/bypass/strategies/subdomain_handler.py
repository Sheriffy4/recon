...
class SubdomainStrategyHandler:
    ...
    def set_subdomain_strategy(self, domain: str, strategy: BypassStrategy, 
                             platform: PlatformType = None, subdomain_type: SubdomainType = None) -> bool:
        """
    ...
    def _initialize_platform_configs(self) -> None:
        ...
        youtube_patterns = [
            SubdomainPattern(r"^www\.youtube\.com$", SubdomainType.WEB_INTERFACE, PlatformType.YOUTUBE, "Main YouTube interface", 10),
            SubdomainPattern(r"^m\.youtube\.com$", SubdomainType.WEB_INTERFACE, PlatformType.YOUTUBE, "Mobile YouTube interface", 9),
            SubdomainPattern(r"^.*\.googlevideo\.com$", SubdomainType.MEDIA_CONTENT, PlatformType.YOUTUBE, "YouTube video content", 10, True),
            SubdomainPattern(r"^i\.ytimg\.com$", SubdomainType.STATIC_ASSETS, PlatformType.YOUTUBE, "YouTube thumbnails", 8),
            SubdomainPattern(r"^.*\.youtube\.com$", SubdomainType.API_ENDPOINT, PlatformType.YOUTUBE, "YouTube API endpoints", 5),
        ]
        ...
        twitter_patterns = [
            SubdomainPattern(r"^(www\.)?twitter\.com$", SubdomainType.WEB_INTERFACE, PlatformType.TWITTER, "Main Twitter interface", 10),
            SubdomainPattern(r"^mobile\.twitter\.com$", SubdomainType.WEB_INTERFACE, PlatformType.TWITTER, "Mobile Twitter interface", 9),
            SubdomainPattern(r"^.*\.twimg\.com$", SubdomainType.MEDIA_CONTENT, PlatformType.TWITTER, "Twitter media content", 10, True),
            SubdomainPattern(r"^api\.twitter\.com$", SubdomainType.API_ENDPOINT, PlatformType.TWITTER, "Twitter API", 8),
            SubdomainPattern(r"^upload\.twitter\.com$", SubdomainType.UPLOAD, PlatformType.TWITTER, "Twitter upload service", 7),
            SubdomainPattern(r"^abs\.twimg\.com$", SubdomainType.STATIC_ASSETS, PlatformType.TWITTER, "Twitter static assets", 6),
        ]
        ...
        instagram_patterns = [
            SubdomainPattern(r"^(www\.)?instagram\.com$", SubdomainType.WEB_INTERFACE, PlatformType.INSTAGRAM, "Main Instagram interface", 10),
            SubdomainPattern(r"^.*\.cdninstagram\.com$", SubdomainType.MEDIA_CONTENT, PlatformType.INSTAGRAM, "Instagram media CDN", 10, True),
            SubdomainPattern(r"^.*\.fbcdn\.net$", SubdomainType.MEDIA_CONTENT, PlatformType.INSTAGRAM, "Facebook CDN for Instagram", 9, True),
            SubdomainPattern(r"^i\.instagram\.com$", SubdomainType.API_ENDPOINT, PlatformType.INSTAGRAM, "Instagram API", 8),
            SubdomainPattern(r"^upload\.instagram\.com$", SubdomainType.UPLOAD, PlatformType.INSTAGRAM, "Instagram upload service", 7),
        ]
        ...
        tiktok_patterns = [
            SubdomainPattern(r"^(www\.)?tiktok\.com$", SubdomainType.WEB_INTERFACE, PlatformType.TIKTOK, "Main TikTok interface", 10),
            SubdomainPattern(r"^.*\.tiktokcdn\.com$", SubdomainType.MEDIA_CONTENT, PlatformType.TIKTOK, "TikTok video CDN", 10, True),
            SubdomainPattern(r"^.*\.musical\.ly$", SubdomainType.MEDIA_CONTENT, PlatformType.TIKTOK, "Legacy Musical.ly content", 8, True),
            SubdomainPattern(r"^api.*\.tiktok\.com$", SubdomainType.API_ENDPOINT, PlatformType.TIKTOK, "TikTok API", 7),
        ]
    ...
    def _get_platform_strategy(self, domain: str, platform: PlatformType, 
                             subdomain_type: SubdomainType, port: int) -> Optional[BypassStrategy]:
        """Get platform-specific strategy."""
        platform_config = self.platform_configs.get(platform)
        if not platform_config:
            return None
        ...
        if strategy:
            ...
            customized_strategy = BypassStrategy(
                ...
                target_ports=strategy.target_ports.copy() if hasattr(strategy, 'target_ports') else [port],
    ...
    def _cache_subdomain_strategy(self, domain: str, platform: PlatformType, 
                                subdomain_type: SubdomainType, strategy: BypassStrategy) -> None:
