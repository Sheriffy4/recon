...
try:
    ...
    def test_basic_functionality():
        ...
        try:
            ...
            converted_strategy = selector._convert_user_preference_to_strategy(user_pref)
            ...
            score = selector._score_strategy(test_strategy, "example.com", 443, domain_analysis)
            ...
            strategies = [
                BypassStrategy(id="s1", name="Strategy 1", attacks=["tcp_fragmentation"], success_rate=0.7),
                BypassStrategy(id="s2", name="Strategy 2", attacks=["http_manipulation"], success_rate=0.9),
            ]
