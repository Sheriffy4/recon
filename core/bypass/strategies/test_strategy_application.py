...
from .pool_management import StrategyPool, StrategyPoolManager, BypassStrategy, PoolPriority
from ..attacks.modern_registry import ModernAttackRegistry
from ..attacks.attack_definition import AttackDefinition, AttackCategory, AttackComplexity, AttackStability
...
class TestEnhancedStrategySelector:
    ...
    def _create_test_pools(self):
        ...
        general_pool = self.pool_manager.create_pool(
            "General",
            self.test_strategies['general_strategy'],
            "For general sites"
        )
