...
class PerformanceMonitor:
    ...
    def sample_memory_usage(self) -> float:
        ...
        try:
            ...
            if memory_mb > self.memory_alert_threshold_mb:
                self._trigger_alert(
                    "high_memory",
                    {"memory_mb": memory_mb, "threshold_mb": self.memory_alert_threshold_mb},
                )
        ...
        with self._lock:
            stats = {
                ...
                "sni_success_rate": self._calculate_success_rate(
                    self.metrics.sni_extraction_success, self.metrics.sni_extraction_attempts
                ),
                "host_success_rate": self._calculate_success_rate(
                    self.metrics.host_extraction_success, self.metrics.host_extraction_attempts
                ),
    ...
    def _calculate_memory_stats(self) -> Dict[str, float]:
        ...
        if not self.metrics.memory_usage_samples:
            return {"current_mb": 0.0, "min_mb": 0.0, "max_mb": 0.0, "avg_mb": 0.0}
    ...
    def _trigger_alert(self, alert_type: str, alert_data: Dict[str, Any]) -> None:
        ...
        if self.metrics.last_alert_time and current_time - self.metrics.last_alert_time < 60:
            return
    ...
    def get_dashboard_data(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "alerts": {"total_count": stats["alert_count"], "last_alert": stats["last_alert_time"]},
