...
class FeatureFlagManager:
    ...
    def enable_feature(
        self, feature_name: str, rollout_stage: RolloutStage = RolloutStage.FULL
    ) -> bool:
        """
    ...
    def rollback_to_point(self, rollback_path: str) -> bool:
        ...
        try:
            ...
            current_backup = (
                ...
                / f"feature_flags_pre_rollback_{datetime.now().strftime('%Y%m%d_%H%M%S')}.json"
            )
            import shutil
    ...
    def _check_rollout_stage(
        self, feature: FeatureConfig, context: Optional[Dict[str, Any]]
    ) -> bool:
