...
class RolloutMonitor:
    ...
    def check_health(self, feature_name: str) -> RolloutHealth:
        ...
        if feature_name in self.thresholds:
            alerts.extend(self._check_thresholds(feature_name, error_rate, performance_impact, success_rate))
    ...
    def set_threshold(self, feature_name: str, metric_type: MetricType, threshold: MetricThreshold) -> None:
        """
    ...
    def _calculate_health_score(self, error_rate: float, performance_impact: float, success_rate: float) -> float:
        """
    ...
    def _check_thresholds(self, feature_name: str, error_rate: float, 
                         performance_impact: float, success_rate: float) -> List[Alert]:
...
def email_alert_handler(alert: Alert, email_config: Dict[str, str]) -> None:
    ...
    LOG.info(f"EMAIL ALERT: Would send email about {alert.feature_name} to {email_config.get('recipients', [])}")
