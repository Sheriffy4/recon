...
Advanced Implementations: {len(self.advanced_attacks)} ({len(self.advanced_attacks)/self.total_attacks*100:.1f}%)
Primitive Only: {len(self.primitive_attacks)} ({len(self.primitive_attacks)/self.total_attacks*100:.1f}%)
...
class AttackAuditor:
    ...
    def audit_registrations(self) -> AttackAuditReport:
        ...
        report.attacks_by_category = {category: [] for category in AttackCategories.__dict__.values() 
        ...
        logger.info(f"✅ Registration audit complete:")
    ...
    def analyze_log_fallbacks(self, log_paths: Optional[List[str]] = None) -> Dict[str, int]:
        ...
        logger.info(f"✅ Log analysis complete:")
    ...
    def generate_comprehensive_report(self, 
                                    ...
                                    log_paths: Optional[List[str]] = None) -> AttackAuditReport:
        """
