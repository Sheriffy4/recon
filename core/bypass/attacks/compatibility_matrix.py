...
class CompatibilityMatrix:
    ...
    def _map_tcp_fragmentation_attacks(self):
        ...
        self.mappings["simple_fragment"] = {
            ExternalTool.ZAPRET: ToolMapping(
                ...
                parameter_mappings={"split_pos": "dpi_desync_split_pos"},
            ...
            ExternalTool.GOODBYEDPI: ToolMapping(
                ...
                parameter_mappings={"split_pos": "fragment_position"},
                flags=["-f"],
            ...
            ExternalTool.BYEBYEDPI: ToolMapping(
                ...
                parameter_mappings={"split_pos": "split_position"},
                flags=["--split-pos"],
        ...
        self.mappings["multisplit"] = {
            ExternalTool.ZAPRET: ToolMapping(
                ...
                parameter_mappings={"positions": "dpi_desync_split_pos"},
                flags=["--dpi-desync=split"],
        ...
        self.mappings["wssize_limit"] = {
            ExternalTool.ZAPRET: ToolMapping(
                ...
                parameter_mappings={"window_size": "wssize"},
                flags=["--wssize"],
    ...
    def _map_combo_attacks(self):
        ...
        self.mappings["badsum_race"] = {
            ExternalTool.ZAPRET: ToolMapping(
                ...
                parameter_mappings={"fake_ttl": "dpi_desync_ttl"},
        ...
        self.mappings["zapret_style_combo"] = {
            ExternalTool.ZAPRET: ToolMapping(
                ...
                flags=[
                    "--dpi-desync=fake,split,disorder",
    ...
    def get_tool_mapping(
        self, attack_id: str, tool: ExternalTool
    ...
    def convert_to_tool_command(
        self, attack_id: str, tool: ExternalTool, parameters: Dict[str, Any]
    ) -> Optional[str]:
    ...
    def parse_tool_command(
        self, tool: ExternalTool, command: str
    ...
    def _extract_parameters_from_command(
        self, command: str, mapping: ToolMapping
    ) -> Dict[str, Any]:
        ...
        for native_param, tool_param in mapping.parameter_mappings.items():
            ...
            if tool_param == "dpi_desync_split_pos":
                ...
                if match:
                    value = match.group(1)
                    if "," in value:
                        parameters[native_param] = [
                            int(x) for x in value.split(",") if x.isdigit()
                        ]
                    elif value.isdigit():
    ...
    def get_best_tool_for_attack(
        self, attack_id: str
    ) -> Optional[Tuple[ExternalTool, float]]:
    ...
    def get_summary(self) -> Dict[str, Any]:
        ...
        for tool in ExternalTool:
            compatible_attacks = [
                attack_id
                for attack_id, mappings in self.mappings.items()
                if tool in mappings
            ]
        ...
        return {
            ...
            "average_compatibility_scores": {
                ...
                / max(
                    1,
                    len([1 for mappings in self.mappings.values() if tool in mappings]),
                )
                for tool in ExternalTool
            },
        }
