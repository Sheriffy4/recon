...
@register_attack(
    ...
    required_params=[],
    optional_params={"reorder_strategy": "random", "preserve_critical": True, "custom_order": None},
...
class TLSExtensionReorderAttack(TLSAttackBase):
    ...
    def optional_params(self) -> Dict[str, Any]:
        return {"reorder_strategy": "random", "preserve_critical": True, "custom_order": None}
    ...
    def execute(self, context: AttackContext) -> AttackResult:
        ...
        try:
            ...
            reordered_extensions = self._reorder_extensions(
                original_extensions, reorder_strategy, preserve_critical, custom_order
            )
            ...
            return self.create_tls_result(
                modified_payload, payload, "extension_reorder", result_metadata
            )
    ...
    def _apply_custom_order(
        self, extensions: List[Dict[str, Any]], custom_order: List[int]
    ) -> List[Dict[str, Any]]:
        """
...
@register_attack(
    ...
    priority=RegistrationPriority.HIGH,
    required_params=[],
    optional_params={"padding_size": 16, "padding_count": 1, "random_content": True},
...
class TLSExtensionPaddingAttack(TLSAttackBase):
    ...
    @property
    def optional_params(self) -> Dict[str, Any]:
        return {"padding_size": 16, "padding_count": 1, "random_content": True}
    ...
    def execute(self, context: AttackContext) -> AttackResult:
        ...
        try:
            ...
            for i in range(padding_count):
                ...
                padding_ext = {"type": 21, "length": len(padding_data), "data": padding_data}
            ...
            return self.create_tls_result(
                modified_payload, payload, "extension_padding", result_metadata
            )
    ...
    def execute(self, context: AttackContext) -> AttackResult:
        ...
        try:
            ...
            grease_values = random.sample(
                self.GREASE_VALUES, min(grease_count, len(self.GREASE_VALUES))
            )
            ...
            if inject_version:
                ...
                if supported_versions_ext:
                    ...
                    if len(versions_data) > 0:
                        ...
                        versions_data = (
                            bytes([versions_data[0] + 2]) + grease_version + versions_data[1:]
                        )
            ...
            return self.create_tls_result(
                modified_payload, payload, "grease_injection", result_metadata
            )
...
class TLS13ExtensionManipulationAttack(TLSAttackBase):
    ...
    def execute(self, context: AttackContext) -> AttackResult:
        ...
        try:
            ...
            manipulate_supported_versions = context.params.get(
                "manipulate_supported_versions", True
            )
            ...
            if manipulate_supported_versions:
                ...
                if supported_versions_ext:
                    ...
                    if len(versions_data) > 1:
                        ...
                        reversed_versions = b"".join(
                            [versions[i : i + 2] for i in range(0, len(versions), 2)][::-1]
                        )
            ...
            return self.create_tls_result(
                modified_payload, payload, "tls13_extension_manipulation", result_metadata
            )
