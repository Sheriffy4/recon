...
def safe_create_attack_result(status_name: str, error_message: str='', technique_used: str='', latency_ms: float=0.0, packets_sent: int=0, bytes_sent: int=0, modified_payload: Optional[bytes]=None, metadata: Optional[Dict[str, Any]]=None, **kwargs):
    """
...
def create_success_result(technique_used: str='', latency_ms: float=0.0, **kwargs):
    ...
    return safe_create_attack_result(status_name='SUCCESS', technique_used=technique_used, latency_ms=latency_ms, **kwargs)

def create_error_result(error_message: str, technique_used: str='', latency_ms: float=0.0, **kwargs):
    """Create an error AttackResult."""
    return safe_create_attack_result(status_name='ERROR', error_message=error_message, technique_used=technique_used, latency_ms=latency_ms, **kwargs)

def create_failed_result(error_message: str, technique_used: str='', latency_ms: float=0.0, **kwargs):
    """Create a failed AttackResult."""
    return safe_create_attack_result(status_name='FAILED', error_message=error_message, technique_used=technique_used, latency_ms=latency_ms, **kwargs)

def create_timeout_result(error_message: str='Attack timed out', technique_used: str='', latency_ms: float=0.0, **kwargs):
    """Create a timeout AttackResult."""
    return safe_create_attack_result(status_name='TIMEOUT', error_message=error_message, technique_used=technique_used, latency_ms=latency_ms, **kwargs)

def create_invalid_params_result(error_message: str, technique_used: str='', **kwargs):
    """Create an invalid parameters AttackResult."""
    return safe_create_attack_result(status_name='INVALID_PARAMS', error_message=error_message, technique_used=technique_used, **kwargs)