...
from .modern_registry import ModernAttackRegistry, get_modern_registry
    ...
    tcp_attack = AttackDefinition(
        ...
        examples=[
            ...
            },
            {
                ...
                "parameters": {"fragment_size": 32, "fragment_delay_ms": 5, "randomize_order": True},
...
def demonstrate_registry_operations():
    ...
    for attack_id in all_attacks:
        ...
        LOG.info(f"  - {attack_id}: {definition.name} (Category: {definition.category.value}, "
