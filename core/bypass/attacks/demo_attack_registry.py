...
def create_demo_attack_definitions():
    ...
    http_attack = AttackDefinition(
        ...
        conflicts_with=["demo_tcp_fragmentation"],
        examples=[
            {
...
def demonstrate_registry_operations():
    ...
    for attack_id in all_attacks:
        ...
        LOG.info(
            f"  - {attack_id}: {definition.name} (Category: {definition.category.value}, Complexity: {definition.complexity.value}, Overall Score: {definition.get_overall_score():.2f})"
        )
