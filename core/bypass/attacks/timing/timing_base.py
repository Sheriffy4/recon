            ...
            if self.config.pattern == TimingPattern.CONSTANT:
                ...
                if count > 1:
                    ...
                    delay = (
                        ...
                        * (self.config.max_delay_ms / self.config.min_delay_ms) ** progress
                    )
                else:
                    delay = self.config.base_delay_ms
                ...
                if burst_position < self.config.burst_size:
                    ...
                    delay = self.config.burst_gap_ms
        ...
        attack_result.metadata.update(
            {
                ...
                "pattern_used": (
                    timing_result.pattern_used.value if timing_result.pattern_used else None
                ),
