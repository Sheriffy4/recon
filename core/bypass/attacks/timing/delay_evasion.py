# recon/core/bypass/attacks/timing/delay_evasion.py
...
from .timing_base import TimingAttackBase, TimingConfiguration, TimingResult
...
class DelayEvasionAttack(TimingAttackBase):
    ...
    def get_delay_evasion_statistics(self) -> Dict[str, Any]:
        ...
        if self.response_time_history:
            stats.update({
                "avg_response_time_ms": sum(self.response_time_history) / len(self.response_time_history),
