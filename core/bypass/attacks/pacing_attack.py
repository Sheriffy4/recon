...
class PacingAttack(AdvancedAttack):
    ...
    async def execute(self, context: AttackContext) -> AttackResult:
        ...
        try:
            ...
            # Get parameters from config and context
...
# --- Registration with AdvancedAttackRegistry ---
...
pacing_attack_config = AdvancedAttackConfig(
    ...
    dpi_signatures=["resource_limited_dpi", "stateful_timeout_dpi", "generic_stateful_inspector"],
