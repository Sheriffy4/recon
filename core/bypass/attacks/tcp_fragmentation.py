...
class BaseTCPFragmentationAttack(BaseAttack):
    ...
    def __init__(self, attack_adapter=None):
        super().__init__(attack_adapter)
        self.logger = LOG
    
    def _create_tcp_segments(self, context: AttackContext, config: TCPFragmentationConfig) -> List[SegmentTuple]:
        """
    ...
    def _calculate_split_positions(self, payload: bytes, config: TCPFragmentationConfig) -> List[int]:
        ...
        if config.split_positions:
            ...
            positions = [pos for pos in config.split_positions if 0 < pos < len(payload)]
...
def register_tcp_fragmentation_attacks():
    ...
    simple_fragment_def = AttackDefinition(
        ...
        parameters={
            "split_pos": {"type": "int", "default": 3, "min": 1, "max": 100, "description": "Position to split payload"},
            "fragment_count": {"type": "int", "default": 3, "min": 2, "max": 10, "description": "Number of fragments"}
        },
    ...
    fake_disorder_def = AttackDefinition(
        ...
        supported_ports=[80, 443],
        parameters={
            "split_pos": {"type": "int", "default": 3, "min": 1, "max": 50, "description": "Position to split payload"},
            "fake_ttl": {"type": "int", "default": 2, "min": 1, "max": 10, "description": "TTL for fake packet"},
            "delay_ms": {"type": "float", "default": 2.0, "min": 0.1, "max": 10.0, "description": "Delay between fragments"}
        },
    ...
    multisplit_def = AttackDefinition(
        ...
        supported_ports=[80, 443],
        parameters={
            "positions": {"type": "list", "default": [1, 3, 10], "description": "List of split positions"},
            "randomize": {"type": "bool", "default": False, "description": "Randomize fragment order"}
        },
    ...
    sequence_overlap_def = AttackDefinition(
        ...
        parameters={
            "split_pos": {"type": "int", "default": 3, "min": 1, "max": 50, "description": "Position to split payload"},
            "overlap_size": {"type": "int", "default": 10, "min": 1, "max": 100, "description": "Size of sequence overlap"},
            "fake_ttl": {"type": "int", "default": 2, "min": 1, "max": 10, "description": "TTL for fake packet"}
        },
    ...
    window_manipulation_def = AttackDefinition(
        ...
        supported_ports=[80, 443],
        parameters={
            "window_size": {"type": "int", "default": 1, "min": 1, "max": 10, "description": "TCP window size"},
            "delay_ms": {"type": "float", "default": 50.0, "min": 1.0, "max": 100.0, "description": "Delay between segments"},
            "fragment_count": {"type": "int", "default": 5, "min": 2, "max": 20, "description": "Number of fragments"}
        },
        default_parameters={"window_size": 1, "delay_ms": 50.0, "fragment_count": 5},
        required_parameters=["window_size"],
        external_tool_mappings={
            "zapret": "--wssize={window_size}"
        },
    ...
    tcp_options_def = AttackDefinition(
        ...
        supported_ports=[80, 443],
        parameters={
            "split_pos": {"type": "int", "default": 5, "min": 1, "max": 50, "description": "Position to split payload"},
            "options_type": {"type": "str", "default": "mss", "choices": ["mss", "window_scale", "timestamp", "sack_permitted", "md5_signature", "custom"], "description": "Type of TCP options to add"},
            "bad_checksum": {"type": "bool", "default": False, "description": "Use bad TCP checksum"}
        },
        default_parameters={"split_pos": 5, "options_type": "mss", "bad_checksum": False},
