# recon/core/bypass/attacks/http/header_attacks.py
"""
...
class HTTPHeaderCaseAttack(BaseAttack):
    ...
    def execute(self, context: AttackContext) -> AttackResult:
        ...
        try:
            ...
            for line in lines:
                if b":" in line and line != lines[0]:  # Header line (not request line)
...
class HTTPHeaderOrderAttack(BaseAttack):
    ...
    def execute(self, context: AttackContext) -> AttackResult:
        ...
        try:
            ...
            if body_start > 0:
                modified_lines.append(b"")  # Empty line before body
...
class HTTPHeaderInjectionAttack(BaseAttack):
    ...
    def execute(self, context: AttackContext) -> AttackResult:
        ...
        try:
            ...
            # Find insertion point (after request line, before body)
            insertion_point = 1
            for i, line in enumerate(lines[1:], 1):
                if line == b"":
                    insertion_point = i
