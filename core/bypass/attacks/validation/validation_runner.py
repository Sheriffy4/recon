...
from core.bypass.attacks.validation.attack_validator import (
    AttackValidator,
    ValidationReport
)
        ...
        for attack_class in attack_classes:
            ...
            try:
                ...
                if report.failed_checks == 0:
                    ...
                    logger.warning(f"❌ {attack_name} validation failed: "
...
Overall Statistics:
  ...
  Attacks Passed: {passed_attacks} ({passed_attacks/total_attacks*100:.1f}%)
  Attacks Failed: {failed_attacks} ({failed_attacks/total_attacks*100:.1f}%)
  
  Total Checks: {total_checks}
  Checks Passed: {total_passed} ({total_passed/total_checks*100:.1f}%)
