...
import asyncio
import time
from recon.core.bypass.attacks.dns.dns_tunneling import DoHAttack, DoTAttack, DNSQueryManipulation, DNSCachePoisoningPrevention, DoHProvider, DoTProvider, get_dns_attack_definitions
from recon.core.bypass.attacks.base import AttackResult
