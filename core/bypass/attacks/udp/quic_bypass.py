...
class QUICBypassAttack(UDPAttackBase):
    ...
    def _inject_padding_frames(self, packet: bytearray, quic_packet: QUICPacket) -> bytearray:
    ...
    def _manipulate_token(self, packet: bytearray, quic_packet: QUICPacket) -> bytearray:
