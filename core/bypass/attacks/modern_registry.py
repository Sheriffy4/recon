...
class TestResult:
    ...
    def __init__(self, attack_id: str, test_case_id: str, success: bool, 
                 execution_time_ms: float, error_message: str = None, 
...
class ModernAttackRegistry:
    ...
    def test_attack(self, attack_id: str, test_case_id: str = None) -> Optional[TestResult]:
        ...
        with self._lock:
            ...
            try:
                ...
                success = (
                    isinstance(result, AttackResult) and 
                ...
                test_result = TestResult(
                    ...
                    metadata={
                        ...
                        'actual_result': result.status.value if isinstance(result, AttackResult) else str(result)
                    }
                )
    ...
    def _save_to_storage(self):
        ...
        try:
            ...
            data = {
                'definitions': {aid: definition.to_dict() for aid, definition in self._definitions.items()},
                'test_results': {aid: [tr.to_dict() for tr in results] for aid, results in self._test_results.items()},
                'stats': self._stats,
                'version': '1.0.0',
