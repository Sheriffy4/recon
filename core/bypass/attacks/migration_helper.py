...
class AttackMigrationHelper:
    ...
    @staticmethod
    def wrap_old_style_result(old_result: AttackResult, original_payload: bytes) -> AttackResult:
        """
    ...
    @staticmethod
    def convert_modified_payload_to_segments(modified_payload: bytes, chunk_size: Optional[int]=None) -> List[SegmentTuple]:
        """
