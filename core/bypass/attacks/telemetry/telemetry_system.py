...
class AttackTelemetrySystem:
    ...
    def __init__(
        ...
        self.execution_logger = AttackExecutionLogger(
            log_level=log_level,
            structured_format=structured_logging
        )
        
        self.error_logger = AttackErrorLogger(
            structured_format=structured_logging
        )
    ...
    def track_execution(
        ...
        try:
            ...
            if self.performance_monitor:
                ...
                throughput_pps = ctx.segments_generated / (execution_time_ms / 1000) if execution_time_ms > 0 else 0
