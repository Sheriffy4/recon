...
from .metrics_exporter import PrometheusExporter, JSONExporter, MetricsFilter
...
class MetricsEndpointHandler(BaseHTTPRequestHandler):
    ...
    def _handle_prometheus_metrics(self, query_params: Dict[str, List[str]]):
        ...
        try:
            ...
            # Send response
            self._send_response(200, metrics_text, self.prometheus_exporter.get_content_type())
    ...
    def _handle_json_metrics(self, query_params: Dict[str, List[str]]):
        ...
        try:
            ...
            # Send response
            self._send_response(200, metrics_json, self.json_exporter.get_content_type())
    ...
    def _handle_health_check(self):
        ...
        try:
            ...
            # Send response
            self._send_response(200, json.dumps(health_data, indent=2), "application/json")
