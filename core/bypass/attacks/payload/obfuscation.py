...
class PayloadObfuscationAttack(PayloadAttackBase):
    ...
    def _apply_substitution(self, payload: bytes, substitution_map: Dict, intensity: int, preserve_structure: bool) -> bytes:
        """
    ...
    def _generate_substitution_map(self, intensity: int, preserve_structure: bool) -> Dict[int, int]:
        """
    ...
    def _apply_noise(self, payload: bytes, noise_probability: float, intensity: int, preserve_structure: bool) -> bytes:
        """
