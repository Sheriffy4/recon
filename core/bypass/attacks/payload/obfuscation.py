# recon/core/bypass/attacks/payload/obfuscation.py
"""
    ...
    def execute(self, context: AttackContext) -> AttackResult:
        ...
        try:
            ...
            if not (0 < split_pos < len(payload)):
                ...
                segments = [
                    (obfuscated1, 0, {"obfuscated": True, "shift": shift}),
                    (obfuscated2, split_pos, {"obfuscated": True, "shift": shift}),
                ]
...
class PayloadBitFlipAttack(PayloadAttack):
    ...
    def execute(self, context: AttackContext) -> AttackResult:
        ...
        try:
            payload = context.payload
            flip_probability = context.params.get(
