...
class PayloadPaddingAttack(PayloadAttackBase):
    ...
    def execute(self, context: AttackContext) -> AttackResult:
        ...
        try:
            ...
            padding_bytes = self._generate_padding(
                padding_size, padding_pattern, custom_byte, original_payload
            )
    ...
    def _generate_padding(
        self, size: int, pattern: str, custom_byte: int, original_payload: bytes
    ) -> bytes:
        """
