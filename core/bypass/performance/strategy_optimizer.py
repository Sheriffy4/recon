...
from .performance_models import OptimizationLevel
...
class StrategyOptimizer:
    ...
    async def optimize_strategy_selection(
        self, domain: str, available_strategies: List[str]
    ) -> str:
        ...
        try:
            ...
            self.logger.debug(
                f"Selected strategy {best_strategy[0]} for domain {domain} with score {best_strategy[1]:.3f}"
            )
            ...
            for strategy_id in all_strategies:
                ...
                if total_attempts > 0:
                    ...
                    recommendation = {
                        ...
                        "effectiveness_score": await self._calculate_strategy_score(
                            strategy_id, domain
                        ),
                    }
        ...
        try:
            ...
            for level in OptimizationLevel:
                ...
                theoretical_score = (
                    ...
                    + (1.0 / (1.0 + avg_execution_time))
                    * temp_weights["execution_time"]
            ...
            optimization_results = {
                ...
                "improvement_potential": optimal_level[1]
                - level_performance[self.optimization_level.value],
