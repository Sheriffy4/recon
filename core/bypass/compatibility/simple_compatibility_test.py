...
def test_basic_functionality():
    ...
    try:
        ...
        zapret_result = detector.detect_tool(
        ...
        zapret_config = zapret_parser.parse(
            "--dpi-desync=split --dpi-desync-split-pos=2"
        )
        ...
        report = bridge.analyze_configuration(
            "--dpi-desync=split --dpi-desync-split-pos=2"
        )
    ...
    try:
        ...
        for config in all_configs:
            try:
                ...
                native_result = bridge.convert_configuration(
                    config, ExternalTool.NATIVE
                )
