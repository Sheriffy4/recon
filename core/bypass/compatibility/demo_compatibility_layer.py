...
from .compatibility_bridge import CompatibilityBridge, get_compatibility_bridge
...
def demo_tool_detection():
    ...
    test_configs = [
        ...
        ("--dpi-desync=fake,disorder --dpi-desync-ttl=8 --dpi-desync-fooling=badsum", "Zapret advanced"),
        ("-f 2 -e -m", "GoodbyeDPI basic"),
        ("goodbyedpi.exe -f 2 --wrong-chksum --set-ttl 64", "GoodbyeDPI with executable"),
