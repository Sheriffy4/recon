...
class TestCompatibilityBridge:
    ...
    def test_migration_summary(self):
        ...
        results = [
            ConversionResult(True, {}, ExternalTool.ZAPRET, ExternalTool.NATIVE, [], [], {}),
            ConversionResult(False, None, ExternalTool.ZAPRET, ExternalTool.NATIVE, [], ["Error"], {})
        ]
...
class TestIntegration:
    ...
    def test_error_handling(self):
        ...
        for config in invalid_configs:
            ...
            assert (report.detected_tool == ExternalTool.UNKNOWN or 
                   not report.parsing_success or 
                   len(report.validation_issues) > 0)
