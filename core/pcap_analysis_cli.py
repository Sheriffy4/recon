...
class PcapAnalyzer:
    ...
    def analyze_pcap_file(
        self, pcap_file: str, strategy_config: Optional[Dict] = None
    ) -> PcapAnalysisResult:
        """
        ...
        successful_connections = sum(
            1 for conn in self.connections.values() if conn.connection_successful
        )
    ...
    def _generate_recommendations(
        ...
        twitter_domains = [
            domain
            for domain in domain_analyses.keys()
    ...
    def export_analysis_report(
        self, result: PcapAnalysisResult, output_file: str, format: str = "json"
    ) -> None:
        """
...
class PcapMonitor:
    ...
    def __init__(
        self,
        interface: str = "any",
        output_file: str = "live_capture.pcap",
...
def analyze_pcap_for_strategies(
    pcap_file: str, config_file: Optional[str] = None
) -> Dict[str, Any]:
    """
