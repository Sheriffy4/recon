...
class DPIConfigLoader:
    ...
    def create_dpi_config_from_file(
        self, config_path: Union[str, Path], domain: Optional[str] = None
    ) -> DPIConfig:
        """
    ...
    def create_dpi_config_from_data(
        self, config_data: Dict[str, Any], domain: Optional[str] = None
    ) -> DPIConfig:
        """
        ...
        try:
            ...
            raise ConfigurationError(
                "config_creation", str(config_data), f"Config creation failed: {e}"
            )
    ...
    def get_preset_config(
        ...
        if preset_name not in presets:
            ...
            raise ConfigurationError(
                "preset", preset_name, f"Preset not found. Available: {available}"
            )
...
def load_dpi_config_for_domain(
    domain: str, config_path: Optional[str] = None
) -> Optional[DPIConfig]:
    """
