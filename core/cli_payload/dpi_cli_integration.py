...
from .dpi_parameter_parser import create_dpi_parameter_parser
...
class DPICLIIntegration:
    ...
    def handle_legacy_zapret_command(self, zapret_command: str) -> DPIConfig:
        ...
        try:
            ...
            raise ConfigurationError(
                "legacy_parsing", zapret_command, f"Legacy parsing failed: {e}"
            )
...
def integrate_dpi_with_existing_cli(
