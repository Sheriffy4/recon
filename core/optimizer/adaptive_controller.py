...
class AdaptiveStrategyController:
    ...
    def __init__(self, base_rules: Dict, zapret_parser, task_translator,
    ...
    def record_outcome(self, key: str, strategy_task: Dict, outcome: str, rtt_ms: Optional[int] = None):
        """
