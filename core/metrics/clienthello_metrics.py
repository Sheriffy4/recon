...
class ClientHelloMetricsCollector:
    ...
    def record_clienthello_size(
        ...
        if size < 1200:
            ...
            LOG.warning(f"⚠️ This may cause FALSE NEGATIVES in strategy testing!")
    ...
    def record_validation_result(
        ...
        if not validation_result.get("valid"):
            ...
            LOG.warning(f"💡 Recommendation: {validation_result.get('recommendation')}")
    ...
    def _generate_recommendations(
        self, overall_stats: ClientHelloStatistics, problematic_domains: List[Dict[str, Any]]
    ) -> List[str]:
