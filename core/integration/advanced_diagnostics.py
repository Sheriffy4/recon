...
class AdvancedDiagnostics:
    ...
    async def run_comprehensive_diagnostics(self) -> SystemDiagnosticReport:
        ...
        try:
            ...
            LOG.info(
                f"Comprehensive diagnostics completed: {len(issues)} issues found, "
    ...
    async def get_optimization_recommendations(
        self, category: Optional[OptimizationCategory] = None, min_priority: int = 1
    ...
    async def get_system_health_summary(self) -> Dict[str, Any]:
        ...
        try:
            ...
            top_recommendations = sorted(
                latest_report.recommendations, key=lambda x: x.priority, reverse=True
            )[:5]
    ...
    async def _diagnose_integration_issues(self) -> List[DiagnosticIssue]:
        ...
        try:
            ...
            phase1_integrations = [
                (
                    "Strategy Prediction",
                    "core.integration.strategy_prediction_integration",
                ),
                ...
                (
                    ...
                    "core.integration.evolutionary_optimization_integration",
                ),
            ]
    ...
    async def _calculate_system_health_score(
        self, issues: List[DiagnosticIssue], system_metrics: Dict[str, Any]
    ) -> float:
