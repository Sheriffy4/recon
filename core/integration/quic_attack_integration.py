...
try:
    from core.bypass.attacks.http.quic_attacks import (
        QUICCidManipulationAttack, QUICPacketCoalescingAttack, QUICMigrationAttack
    )
    ...
    async def _detect_quic_support(self, target: str, context: AttackContext) -> QUICDetectionResult:
        ...
        try:
            ...
            return QUICDetectionResult(
                ...
                detected_features=["quic_support", "http3_support"] if http3_supported else ["quic_support"],
            ...
            return QUICDetectionResult(
                ...
                http3_supported=True,
                confidence=0.5,
                recommended_attacks=["cid_manipulation", "packet_coalescing", "migration"]
            )
    ...
    async def _execute_quic_attack(
        ...
        try:
            ...
            ml_feedback = MLFeedback(
                ...
                adaptation_suggestions=self._generate_quic_suggestions(strategy, result, effectiveness_score)
            )
            ...
            performance_metrics = PerformanceMetrics(
                ...
                network_overhead_bytes=result.bytes_sent if hasattr(result, 'bytes_sent') else 1024,
        ...
        try:
            if effectiveness_score < 0.5:
                suggestions.append(AdaptationSuggestion(
                    ...
                    parameters={"rotation_frequency": "decrease", "migration_frequency": "decrease"},
                    confidence=0.7
                ))
            ...
            if self.error_handler:
                await self.error_handler.handle_error(
                    create_ml_feedback_error(
                        f"QUIC attack adaptation failed: {e}",
                        "quic_attack_integration"
                    )
                )
    ...
    async def get_effectiveness_metrics(self) -> Dict[str, float]:
        ...
        try:
            ...
            overall_effectiveness = (success_rate * 0.4 + 
                                   quic_success_rate * 0.3 + 
                                   http3_success_rate * 0.3)
