...
if not PERFORMANCE_OPTIMIZER_AVAILABLE:
    try:
        from .simple_performance_optimizer import SimplePerformanceOptimizer, SimplePerformanceProfile
...
class BypassPerformanceIntegrator:
    ...
    def get_current_metrics(self) -> BypassPerformanceMetrics:
        ...
        if self.optimizer and self.optimizer.profiles:
            ...
            memory_usage_mb = latest_profile.memory_percent * 10  # Simplified conversion
    ...
    def _optimize_bypass_caches(self) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                "success": True,
                "message": "Bypass caches cleared successfully"
            }
            
        except Exception as e:
            return {
                "success": False,
                "message": f"Failed to clear bypass caches: {e}"
            }
    ...
    def _optimize_attack_pools(self) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                "success": True,
                "message": "Attack pools optimized"
            }
    ...
    def _optimize_ml_models(self) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                "success": True,
                "message": "ML models optimized"
            }
            
        except Exception as e:
            return {
                "success": False,
                "message": f"Failed to optimize ML models: {e}"
            }
