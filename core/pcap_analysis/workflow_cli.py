...
from .automated_workflow import AutomatedWorkflow, WorkflowConfig, run_automated_workflow
...
Examples:
  ...
  python workflow_cli.py --config workflow_config.json
    ...
    parser.add_argument(
        'recon_pcap',
        nargs='?',
        help='Path to recon PCAP file'
    )
    parser.add_argument(
        'zapret_pcap',
        nargs='?',
        help='Path to zapret PCAP file'
    )
    ...
    parser.add_argument(
        '--no-auto-fix',
        action='store_true',
        help='Disable automatic fix application'
    )
    
    parser.add_argument(
        '--no-validation',
        action='store_true',
        help='Disable fix validation'
    )
    ...
    parser.add_argument(
        '--no-backup',
        action='store_true',
        help='Disable file backup before fixes'
    )
    
    parser.add_argument(
        '--no-rollback',
        action='store_true',
        help='Disable rollback on fix failure'
    )
