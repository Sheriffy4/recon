...
class StrategyConfig:
    ...
    def __eq__(self, other) -> bool:
        ...
        return (
            self.dpi_desync == other.dpi_desync and
            self.split_pos == other.split_pos and
            self.split_seqovl == other.split_seqovl and
            self.ttl == other.ttl and
            self.autottl == other.autottl and
            self.fooling == other.fooling and
            self.fake_tls == other.fake_tls and
            self.fake_http == other.fake_http and
            self.fake_quic == other.fake_quic and
            self.repeats == other.repeats and
