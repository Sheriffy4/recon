...
class ComparisonResult:
    ...
    def add_sequence_difference(self, recon_packet: PacketInfo, zapret_packet: PacketInfo, 
                              difference_type: str, description: str, severity: str = "medium"):
    ...
    def add_timing_difference(self, description: str, recon_timing: float, 
                            zapret_timing: float, impact: str = "medium"):
    ...
    def add_parameter_difference(self, parameter: str, recon_value: Any, 
                               zapret_value: Any, impact: str = "medium"):
    ...
    def calculate_similarity_score(self) -> float:
        ...
        param_similarity = 1.0 - len(self.parameter_differences) / 10  # Normalize by expected params
    ...
    def get_summary(self) -> Dict[str, Any]:
        ...
        return {
            'files_compared': {
                'recon': self.recon_file,
                'zapret': self.zapret_file
            },
            'packet_counts': {
