    ...
    def _deploy_docker(self, config) -> bool:
        ...
        try:
            ...
            build_result = subprocess.run([
                "docker", "build", 
                "-t", "pcap-analysis:latest",
                "-f", "recon/core/pcap_analysis/deployment/Dockerfile",
                "."
            ...
            compose_result = subprocess.run([
                "docker-compose", 
                "-f", "recon/core/pcap_analysis/deployment/docker-compose.yml",
    ...
    def _check_api_endpoints(self, config) -> bool:
        ...
        try:
            ...
            for endpoint in endpoints:
                ...
                if response.status_code not in [200, 404]:  # 404 is OK for optional endpoints
                    return False
...
def main():
    ...
    parser.add_argument("--type", choices=["docker", "kubernetes", "systemd"], 
