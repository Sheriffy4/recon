...
class CriticalDifference:
    ...
    def add_evidence(self, evidence_type: str, description: str, 
                    data: Dict[str, Any] = None, confidence: float = 1.0):
    ...
    def is_blocking(self) -> bool:
        ...
        blocking_indicators = [
            ...
            self.confidence >= 0.8,
            self.fix_priority <= 3,
            self.category in [DifferenceCategory.SEQUENCE, DifferenceCategory.TTL, 
    ...
    def __str__(self) -> str:
        ...
        return (f"CriticalDifference({self.category.value}, "
    ...
    def __repr__(self) -> str:
        ...
        return (f"CriticalDifference(category={self.category.value}, "
