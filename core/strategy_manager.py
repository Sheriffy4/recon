...
class StrategyManager:
    ...
    def __init__(self, strategies_file: str = "domain_strategies.json", legacy_file: str = "best_strategy.json"):
        ...
        if self.legacy_file.exists():
            try:
                ...
                if 'strategy' in data:
                    ...
                    self.logger.info(f"Converted legacy strategy for default domain")
            except Exception as e:
    ...
    def add_strategy(self, domain: str, strategy: str, success_rate: float, avg_latency_ms: float):
