# recon/core/optimization/performance_optimizer.py
...
class PerformanceOptimizer:
    ...
    def __init__(self, name: str = "PerformanceOptimizer"):
        ...
        # Оптимизации
        self._optimizations: List[Callable] = [
            self._optimize_gc,
    ...
    def start_monitoring(self) -> None:
        ...
        try:
            ...
            self._monitoring_active = False
            # Continue operation without monitoring (graceful degradation)
    ...
    def stop_monitoring(self) -> None:
        ...
        if self._monitoring_thread and self._monitoring_thread.is_alive():
            ...
            timeout = max(self.monitoring_interval * 2, 10.0)  # At least 10 seconds
            ...
            if self._monitoring_thread.is_alive():
                ...
                # Mark it as inactive and continue
            else:
    ...
    def _monitoring_loop(self) -> None:
        ...
        while self._monitoring_active:
            try:
                ...
                if len(self.profiles) >= 10:  # Достаточно данных
                ...
                # Wait longer after errors to avoid rapid error loops
                self._interruptible_sleep(min(self.monitoring_interval * 2, 30))
                continue

            # Use interruptible sleep that can be woken up quickly
    ...
    def _interruptible_sleep(self, duration: float) -> None:
        ...
        """
        # Sleep in small chunks so we can check _monitoring_active frequently
    ...
    def _collect_profile(self) -> PerformanceProfile:
        ...
        try:
            ...
            # Return a minimal profile to keep monitoring running
            return PerformanceProfile(
                cpu_percent=0.0,
                memory_percent=0.0,
                thread_count=1,
    ...
    def _analyze_and_optimize(self) -> None:
        ...
        # Средние значения за последние профили
        ...
        # Применение оптимизаций при необходимости
    ...
    def _handle_optimization_failure(
        ...
        try:
            ...
            # Even the fallback failed, but we continue operation
    ...
    def _optimize_gc(self) -> Dict[str, Any]:
        ...
        # Настройка порогов GC
        if len(self.profiles) > 0:
            recent_profile = self.profiles[-1]
            if recent_profile.memory_percent > 70:
                # Более агрессивная сборка мусора при высоком использовании памяти
    ...
    def _generate_recommendations(self) -> List[str]:
        ...
        if avg_memory > 80:
            recommendations.append(
                "High memory usage detected. Review memory allocations and enable caching."
            )
    ...
    def start_optimization(self) -> None:
        ...
        try:
            ...
            # Skip complex optimizations for now to prevent hanging
            # Just mark as started for service compatibility
            ...
            # Continue operation without optimization (graceful degradation)
