...
class DynamicParameterOptimizer:
    ...
    async def optimize_parameters(
        ...
        try:
            ...
            for iteration, params in enumerate(param_combinations):
                ...
                try:
                    ...
                    if effectiveness > best_effectiveness:
                        ...
                        self.logger.info(
                            f"New best parameters for {attack_name}: effectiveness={effectiveness:.3f}, params={params}"
                        )
            ...
            self.logger.info(
                f"Parameter optimization completed for {attack_name}: best_effectiveness={best_effectiveness:.3f}, total_tests={len(effectiveness_history)}, time={optimization_time:.1f}ms"
            )
            return result
        except Exception as e:
