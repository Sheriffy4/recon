...
from .ech import ECHConfig, ECHClientHello, ECHCipherSuite, ECHVersion, ECHNonce
...
class PacketEngine:
    ...
    def fragment_tcp_packet(self, ip_packet: IPv4Packet, tcp_packet: TCPPacket, 
                          fragment_size: int = 8) -> list[IPv4Packet]:
    ...
    def create_multisplit_attack(self, ip_packet: IPv4Packet, tcp_packet: TCPPacket,
                               config: Optional[SegmentConfig] = None) -> List[IPv4Packet]:
    ...
    def create_overlap_attack(self, ip_packet: IPv4Packet, tcp_packet: TCPPacket,
                            overlap_data: bytes, offset: int) -> List[IPv4Packet]:
    ...
    def create_quic_packet(self, packet_type: QUICPacketType,
                          version: QUICVersion,
                          dcid: bytes,
                          scid: bytes,
                          payload: bytes = b"") -> QUICPacket:
    ...
    def create_ech_client_hello(self, config: ECHConfig,
                              inner_ch: bytes,
                              cipher_suite: Optional[ECHCipherSuite] = None) -> ECHClientHello:
