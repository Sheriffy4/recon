...
class TCPSegmentManipulator:
    ...
    def multisplit_packet(
        self, ip_packet: IPv4Packet, tcp_packet: TCPPacket, config: SegmentConfig
    ) -> List[IPv4Packet]:
    ...
    def create_overlap_attack(
        ...
        overlap_tcp = self.create_segment(
            tcp_packet, tcp_packet.seq_num + overlap_offset, overlap_data, True
        )
