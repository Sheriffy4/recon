...
def demo_strategy_selection():
    ...
    global_strategy = '--dpi-desync=badsum_race --dpi-desync-ttl=4 --dpi-desync-split-pos=3'
    ...
    test_scenarios = [
        ...
        ('abs.twimg.com', '104.244.42.1', 'domain_wildcard', 'Twitter CDN wildcard match'),
        ('abs-0.twimg.com', '104.244.42.1', 'domain_wildcard', 'Twitter CDN wildcard match'),
        ('pbs.twimg.com', '104.244.42.1', 'domain_wildcard', 'Twitter CDN wildcard match'),
        ('video.twimg.com', '104.244.42.1', 'domain_wildcard', 'Twitter CDN wildcard match'),
        ('ton.twimg.com', '104.244.42.1', 'domain_wildcard', 'Twitter CDN wildcard match'),
        ('youtubei.googleapis.com', '172.217.1.1', 'domain_wildcard', 'Google APIs wildcard match'),
