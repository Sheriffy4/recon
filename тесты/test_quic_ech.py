...
from core.net.quic_packet import QUICPacketType, QUICVersion
from core.net.ech import ECHConfig, ECHClientHello, ECHCipherSuite
...
class TestQUICAndECH(unittest.TestCase):
    ...
    def test_quic_initial_packet(self):
        ...
        self.assertEqual(
            parsed_packet.header.packet_type, initial_packet.header.packet_type
        )
    ...
    def test_quic_version_negotiation(self):
        ...
        self.assertEqual(
            response.header.packet_type, QUICPacketType.VERSION_NEGOTIATION
        )
