...
class TestAttackDefinition(unittest.TestCase):
    ...
    def test_compatibility_checking(self):
        ...
        self.assertFalse(
            self.definition.is_compatible_with(CompatibilityMode.GOODBYEDPI)
        )
    ...
    def test_deprecation(self):
        ...
        self.assertEqual(
            self.definition.deprecation_reason, "Replaced by better attack"
        )
...
class TestModernAttackRegistry(unittest.TestCase):
    ...
    def test_statistics(self):
        ...
        self.assertEqual(
            stats["enabled_attacks"], initial_total + 1
        )  # attack2 is deprecated/disabled
    ...
    def test_category_and_complexity_indexing(self):
        ...
        simple_attacks = self.registry.get_attacks_by_complexity(
            AttackComplexity.SIMPLE
        )
        self.assertIn("tcp_test", simple_attacks)
        self.assertNotIn("http_test", simple_attacks)

        advanced_attacks = self.registry.get_attacks_by_complexity(
...
class TestGlobalRegistryFunctions(unittest.TestCase):
    ...
    def test_global_functions(self, mock_get_registry):
        ...
        from .modern_registry import (
            register_modern_attack,
            get_attack_definition,
            list_modern_attacks,
        )
        ...
        mock_registry.list_attacks.assert_called_once_with(
            category=AttackCategory.TCP_FRAGMENTATION
        )
