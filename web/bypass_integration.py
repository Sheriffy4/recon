...
def create_bypass_integration(pool_config_path: Optional[str] = None,
                            attack_registry_path: Optional[str] = None) -> BypassWebIntegration:
    """
    ...
    try:
        ...
        # Try to create optional components
        test_runner = None
...
def integrate_with_monitoring_server(monitoring_server, bypass_integration: BypassWebIntegration):
    ...
    try:
        ...
        # Setup bypass routes on the monitoring server's app
        bypass_integration.setup_routes(monitoring_server.app)
        
        # Add bypass status to monitoring server's status report
...
if __name__ == "__main__":
    ...
    async def test_bypass_integration():
        ...
        try:
            ...
            # Test API (without actually starting server)
