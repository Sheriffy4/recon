# recon/core/fingerprint/test_ml_classifier.py
"""
...
class TestMLClassifier:
    ...
    def setup_method(self):
        ...
        # Sample metrics for classification
        self.sample_metrics = {
            "rst_ttl": 63,
            "rst_latency_ms": 45,
            "stateful_inspection": True,
    ...
    def test_train_model_invalid_data(self):
        ...
        invalid_data = [
            {"metrics": {}, "invalid_key": "test"},  # Missing dpi_type
            {"dpi_type": "TEST", "invalid_key": "test"},  # Missing metrics
        ]
    ...
    def test_extract_features_missing_metrics(self):
        ...
        # First call to establish feature names
        classifier._extract_features_from_metrics(self.sample_metrics)

        # Second call with missing metrics
        ...
        # Most features should be -1.0 (missing)
    ...
    def test_get_model_info_trained(self):
        ...
        assert info["model_exists"] is True  # Model should be saved after training
...
class TestMLClassifierIntegration:
    ...
    def setup_method(self):
        ...
        self.test_model_path = os.path.join(
            self.temp_dir, "integration_test_model.joblib"
        )
    ...
    def test_full_ml_lifecycle(self):
        ...
        # Step 4: Classify with loaded model
        test_metrics = {
            "rst_ttl": 62,
            "rst_latency_ms": 45,
            "stateful_inspection": True,
