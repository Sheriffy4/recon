# recon/core/fingerprint/test_training_pipeline.py
"""
...
from .training_data import TrainingDataGenerator, FeatureEngineer, TrainingExample
from .model_trainer import ModelTrainer, ModelEvaluationMetrics
...
class TestTrainingDataGenerator(unittest.TestCase):
    ...
    def test_initialization(self):
        ...
        # Check that all DPI types are represented
        dpi_types = {example.dpi_type for example in self.generator.training_examples}
        expected_types = {
            'ROSKOMNADZOR_TSPU', 'ROSKOMNADZOR_DPI', 'COMMERCIAL_DPI',
            'FIREWALL_BASED', 'ISP_TRANSPARENT_PROXY', 'CLOUDFLARE_PROTECTION',
            'GOVERNMENT_CENSORSHIP', 'UNKNOWN'
        }
    ...
    def test_metrics_completeness(self):
        ...
        required_metrics = [
            'rst_ttl', 'rst_latency_ms', 'connection_latency_ms',
            'dns_resolution_time_ms', 'handshake_time_ms'
        ]
    ...
    def test_synthetic_variation_generation(self):
        ...
        # Check that synthetic examples are variations
...
class TestFeatureEngineer(unittest.TestCase):
    ...
    def test_derived_features(self):
        ...
        derived_features = [
            'blocking_intensity', 'technology_support', 'ttl_is_common'
        ]
...
class TestModelTrainer(unittest.TestCase):
    ...
    def test_feature_importance_report(self):
        ...
        # Create trainer with mock evaluation metrics
...
class TestIntegration(unittest.TestCase):
    ...
    def test_end_to_end_training_pipeline(self):
        ...
        with patch.object(trainer.training_data_generator, 'generate_synthetic_variations') as mock_synthetic:
            # Limit synthetic data for faster testing
    ...
    def test_training_data_quality_validation(self):
        ...
        # Validate all examples have required structure
        for example in generator.training_examples:
            self.assertIsInstance(example.dpi_type, str)
            self.assertIn(example.dpi_type, [
