...
class MockAttack(BaseAttack):
    ...
    def __init__(self, attack_id: str = "test_attack", execution_time: float = 0.1, 
                 should_fail: bool = False, result_status: AttackStatus = AttackStatus.SUCCESS):
        super().__init__()
        self.id = attack_id
...
class TestAttackSandbox:
    ...
    def test_threading_constraints(self):
        ...
        # Test thread limit
        constraints2 = SandboxConstraints(
