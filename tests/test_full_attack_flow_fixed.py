...
class TestFullAttackFlow:
    ...
    def test_disorder_full_flow(self):
        ...
        assert result is not None
        self.techniques.apply_disorder.assert_called_once_with(
            payload, 7, ack_first=False
        )
    ...
    def test_multisplit_full_flow(self):
        ...
        assert result is not None
        self.techniques.apply_multisplit.assert_called_once_with(
            payload, positions=[3, 8, 15]
        )
