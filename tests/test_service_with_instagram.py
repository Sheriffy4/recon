...
def create_test_config():
    ...
    print("   domain_strategies.json: Instagram -> fake,disorder")
    print("   sites.txt: instagram.com")
...
def main():
    ...
    try:
        ...
        if all_passed:
            ...
            print(
                "   Служба теперь правильно обрабатывает fake,disorder -> fakeddisorder"
            )
