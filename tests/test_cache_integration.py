...
def test_cache_performance():
    ...
    try:
        ...
        print(f"✓ Inserted {num_entries} entries in {insert_time:.3f}s ({insert_rate:.1f} ops/sec)")
        ...
        print(f"✓ Retrieved {hits} entries in {retrieval_time:.3f}s ({retrieval_rate:.1f} ops/sec)")
