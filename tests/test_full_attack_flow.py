...
class TestFullAttackFlow:
    ...
    def test_fakeddisorder_full_flow(self):
        ...
        ), f"Parameter validation failed: {validation_result.error_message}"
        ...
        assert call_args[1]["fooling_methods"] == [
            "badsum"
        ]  # fooling_methods parameter

    def test_seqovl_full_flow(self):
        """Test complete seqovl attack flow."""
        attack_type = "seqovl"
        payload = b"TLS handshake data"
        params = {"split_pos": 10, "overlap_size": 20, "fake_ttl": 2}
    ...
    def test_fake_packet_race_full_flow(self):
        ...
        params = {"fooling": ["badseq", "badack"], "ttl": 3}
    ...
    def test_special_split_pos_resolution_flow(self):
        ...
        params = {"split_pos": "sni", "ttl": 4}  # Special value
    ...
    def test_parameter_validation_failure_flow(self):
        ...
        attack_type = "fakeddisorder"
        payload = b"Test payload"
        params = {"split_pos": -1, "ttl": 300}  # Invalid value  # Invalid value
...
class TestAttackFlowPerformance:
    ...
    def test_attack_dispatch_performance(self):
        ...
        assert (
            avg_time_per_dispatch < 0.001
        ), f"Dispatch too slow: {avg_time_per_dispatch:.6f}s per call"
    ...
    def test_registry_lookup_performance(self):
        ...
        ), f"Registry lookup too slow: {avg_time_per_lookup:.6f}s per call"
