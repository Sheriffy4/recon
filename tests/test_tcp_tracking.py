...
class TestTCPTracking(unittest.TestCase):
    ...
    def create_tcp_packet(self, src_addr, src_port, dst_addr, dst_port, 
                         seq_num, ack_num, flags, payload=b""):
    ...
    def test_tcp_handshake(self):
        ...
        self.assertEqual(
            self.packet_engine.get_connection_state(ip1, tcp1),
            TCPState.SYN_SENT
        )
        ...
        self.assertEqual(
            self.packet_engine.get_connection_state(ip2, tcp2),
        ...
        self.assertEqual(
            self.packet_engine.get_connection_state(ip3, tcp3),
    ...
    def test_retransmission_detection(self):
        ...
        self.assertTrue(self.packet_engine.tcp_tracker.handle_retransmission(ip2, tcp2, conn))
