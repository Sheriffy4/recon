...
class TestHybridEngineIntegration:
    ...
    async def test_real_world_strategy_execution_success(
        self, MockBypassEngine, hybrid_engine
    ):
        """
        ...
        with patch("asyncio.create_subprocess_exec") as mock_subprocess:
            ...
            expected_curl_call = call(
                ...
                "-sS",
                "--connect-to",
                "::rutracker.org:443:104.21.32.39",
                "--max-time",
                "5.0",
                "-k",
                "-o",
            ...
            mock_subprocess.assert_any_call(
                *expected_curl_call.args, **expected_curl_call.kwargs
            )
    ...
    @patch("core.hybrid_engine.BypassEngine")
    async def test_real_world_strategy_execution_failure(
        self, MockBypassEngine, hybrid_engine
    ):
        """
        ...
        with patch("asyncio.create_subprocess_exec") as mock_subprocess:
            ...
            mock_proc.communicate.return_value = (
                b"",
                b"curl: (28) Connection timed out",
            )
            mock_subprocess.return_value = mock_proc
