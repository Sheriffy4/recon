...
class TestPerformanceOptimizer:
    ...
    async def test_collect_performance_metrics(self, optimizer):
        ...
        ) as mock_memory, patch("psutil.net_io_counters") as mock_network:
    ...
    async def test_get_system_health(self, optimizer):
        ...
        with patch("psutil.cpu_percent", return_value=45.0), patch(
            ...
            "psutil.boot_time", return_value=999000
        ):
...
class TestStrategyOptimizer:
    ...
    async def test_get_strategy_recommendations(self, optimizer):
        ...
        if len(recommendations) > 1:
            assert (
                recommendations[0]["effectiveness_score"]
...
class TestProductionMonitor:
    ...
    def config(self):
        return ProductionConfig(
            ...
            alert_thresholds={"cpu_critical": 90.0, "memory_critical": 85.0},
    ...
    async def test_get_active_alerts(self, monitor):
        ...
        await monitor._create_alert(
            AlertSeverity.ERROR, "Active Alert", "This is an active alert", "test", {}
        )
    ...
    async def test_acknowledge_alert(self, monitor):
        ...
        await monitor._create_alert(
            AlertSeverity.INFO, "Test Alert", "Test message", "test", {}
        )
    ...
    async def test_resolve_alert(self, monitor):
        ...
        await monitor._create_alert(
            AlertSeverity.WARNING, "Resolvable Alert", "Test message", "test", {}
        )
        alert_id = monitor.alerts[0].id
...
class TestAlertingSystem:
    ...
    def alerting_config(self, temp_log_file):
        return {
            ...
            "file": {"enabled": True, "log_file": temp_log_file},
        }
