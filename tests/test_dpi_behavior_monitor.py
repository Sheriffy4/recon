# recon/core/fingerprint/test_dpi_behavior_monitor.py
"""
...
def monitoring_config():
    ...
    return MonitoringConfig(
        ...
        behavior_change_confidence_threshold=0.7,
        unknown_pattern_threshold=0.3,
        enable_alerts=True,
        alert_retention_days=7,
        max_alerts_per_target=5,
        enable_strategy_testing=True,
        strategy_test_timeout=10.0,
...
class TestBehaviorAnalyzer:
    ...
    def test_analyze_significant_change(self, monitoring_config, sample_fingerprint):
        ...
        modified_fp = DPIFingerprint(
            ...
            timestamp=time.time(),
            dpi_type=DPIType.COMMERCIAL_DPI,  # Changed DPI type
            confidence=0.75,
            ...
            dns_over_tcp_blocking=False,
            edns_support=False,
            ip_fragmentation_handling="unknown",
            packet_size_limitations=None,
            protocol_whitelist=[],
            geographic_restrictions=False,
            time_based_filtering=False,
    ...
    def test_calculate_fingerprint_similarity(self, monitoring_config, sample_fingerprint):
        ...
        modified_fp = DPIFingerprint(
            target=sample_fingerprint.target,
            timestamp=time.time(),
            dpi_type=sample_fingerprint.dpi_type,  # Same
...
class TestDPIBehaviorMonitor:
    ...
    async def test_behavior_change_handling(self, mock_fingerprinter, monitoring_config, sample_fingerprint):
        ...
        modified_fp = DPIFingerprint(
            target=sample_fingerprint.target,
            timestamp=time.time(),
            dpi_type=DPIType.COMMERCIAL_DPI,  # Different type
            confidence=0.75,
            analysis_duration=2.0,
            reliability_score=0.8,
