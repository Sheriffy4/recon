...
class TestAdvancedFingerprinteSimple:
    ...
    def test_initialization_custom_config(self):
        ...
        try:
            config = FingerprintingConfig(
                cache_ttl=1800, enable_ml=False, enable_cache=False, timeout=15.0
            )
    ...
    def test_heuristic_classification_patterns(self):
        ...
        try:
            ...
            )  # Should be TSPU due to fast reset (< 100ms)
    ...
    def test_extract_ml_features(self):
        ...
        try:
            ...
            expected_features = [
                ...
                "packet_size_limitations",
                "protocol_whitelist_count",
                "analysis_duration",
            ]
