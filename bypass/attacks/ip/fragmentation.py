# recon/core/bypass/attacks/ip/fragmentation.py
"""
        ...
        try:
            ...
            if len(payload) <= frag_size:
                ...
                while offset < len(payload):
                    # Calculate fragment size with potential overlap
                    current_frag_size = min(frag_size, len(payload) - offset)

                    # Add overlap for non-first fragments
    ...
    def execute(self, context: AttackContext) -> AttackResult:
        ...
        try:
            ...
            if len(payload) <= frag_size:
                ...
                # Return fragments in reverse order
