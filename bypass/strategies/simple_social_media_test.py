...
async def test_instagram_http_port_handling():
    ...
    try:
        ...
        # Test HTTP port (80) - should have special handling
        strategy_http = await social_handler.optimize_instagram_access(
            "instagram.com", 80
        )
        ...
        strategy_https = await social_handler.optimize_instagram_access(
            "instagram.com", 443
        )
...
async def test_effectiveness_testing():
    ...
    try:
        ...
        # Test effectiveness for a few domains
...
async def test_strategy_recommendations():
    ...
    try:
        ...
        # Test recommendations for different platforms
        test_domains = [
            "www.youtube.com",
            "r1---sn-4g5e6nez.googlevideo.com",
            "pbs.twimg.com",
            ...
            try:
                ...
                if recommendations and len(recommendations) > 0:
                    ...
                    if strategy.id and 0.0 <= confidence <= 1.0 and reason:
                        print(
                            f"  ✅ {domain} -> {len(recommendations)} recommendations"
                        )
                        success_count += 1
                    else:
...
async def main():
    ...
    tests = [
        ...
        ("Instagram HTTP Port Handling", test_instagram_http_port_handling),
        ("Effectiveness Testing", test_effectiveness_testing),
