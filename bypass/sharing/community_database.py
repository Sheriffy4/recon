            ...
            with sqlite3.connect(self.db_path) as conn:
                ...
                """,
                    (
                        ...
                        json.dumps(strategy.strategy_data),
                        strategy.author,
                        strategy.version,
                        strategy.share_level.value,
                        strategy.validation_status.value,
                        strategy.trust_score,
                        strategy.download_count,
                        strategy.success_reports,
                        strategy.failure_reports,
                        json.dumps(strategy.tags),
                        json.dumps(strategy.target_regions),
                        json.dumps(strategy.target_isps),
