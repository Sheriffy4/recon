...
def main():
    ...
    parser = argparse.ArgumentParser(description='Monitor recon service logs for x.com bypass validation')
    parser.add_argument('--log-file', help='Path to log file to monitor')
    parser.add_argument('--duration', type=int, default=60, help='Duration to monitor in seconds (default: 60)')
    parser.add_argument('--check-existing', action='store_true', help='Check existing log files for patterns')
