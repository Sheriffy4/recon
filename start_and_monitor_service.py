...
def main():
    ...
    parser = argparse.ArgumentParser(description='Start recon service and monitor logs for x.com bypass validation')
    parser.add_argument('--duration', type=int, default=120, help='Duration to monitor in seconds (default: 120)')
