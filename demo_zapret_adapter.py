...
def demo_adapter_execution():
    ...
    adapters = {
        ...
        "Direct Mode": ZapretAttackAdapter(ZapretAdapterConfig(mode=ZapretAdapterMode.DIRECT)),
    ...
    for adapter_name, adapter in adapters.items():
        ...
        try:
            ...
            print(f"Execution mode would be: {adapter._determine_execution_mode().value}")
...
def demo_factory_functions():
    ...
    print(f"Performance adapter configuration: {performance_adapter.get_configuration()}")
